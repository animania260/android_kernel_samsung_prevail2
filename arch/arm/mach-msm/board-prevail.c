...
#endif
#ifdef CONFIG_SENSORS_YAS_ACCEL_DRIVER
#include <linux/i2c/k2dm.h>
#endif
#ifdef CONFIG_SENSORS_YAS530C
#include <linux/yas.h>
#endif
#include <linux/i2c-gpio.h>
...
#else
#define MSM_FB_PRIM_BUF_SIZE   (320 * 480 * 4 * 2) /* 4bpp * 2 Pages */
#endif
...
#define MSM_FB_OVERLAY0_WRITEBACK_SIZE (320 * 480 * 3 * 2)
#else
...
#define PMIC_GPIO_VOLUME_UP	25
#define PMIC_GPIO_CHG_STAT	23
...
#define PMIC_TA_CURRENT_SEL	37
#define GPIO_TFLASH_EN	176	/* TFLASH_EN GPIO after hw rev.02 */
...
#ifdef CONFIG_SENSORS_TAOS
#define OPT_GPIO_ALS_SDA			128
#define OPT_GPIO_ALS_SCL			124
#define PMIC_GPIO_PS_VOUT				PM8058_GPIO(30)
#endif
#if defined(CONFIG_SENSORS_YAS_ACCEL_DRIVER) || defined(CONFIG_SENSORS_YAS530C)
#define ACCEL_SENSORS_GPIO_SDA			1
#define ACCEL_SENSORS_GPIO_SCL			0
...
static int pm8058_gpios_init(void)
{
	...
	struct pm8xxx_gpio_init_info volume_key_inconfig = {
	...
	struct pm8xxx_gpio_init_info gpio38 = {
		PM8058_GPIO_PM_TO_SYS(PMIC_TA_CURRENT_SEL),
		{
		 .direction = PM_GPIO_DIR_IN,
		 .pull = PM_GPIO_PULL_NO,
		 .vin_sel = 2,
...
#ifdef CONFIG_SENSORS_TAOS
	struct pm8xxx_gpio_init_info ps_vout = {
		PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_PS_VOUT),
		{
		 .direction = PM_GPIO_DIR_IN,
		 .pull = PM_GPIO_PULL_NO,
		 .vin_sel = 2,
...
#endif
	struct pm8xxx_gpio_init_info cam_flash_set = {
		PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_CAM_FLASH_SET),
		{
		 .direction = PM_GPIO_DIR_OUT,
		 .output_buffer = PM_GPIO_OUT_BUF_CMOS,
		 .output_value = 0,
	...
	struct pm8xxx_gpio_init_info cam_flash_en = {
...
#endif
	rc = pm8xxx_gpio_config(volume_key_inconfig.gpio,
				&volume_key_inconfig.config);
	if (rc) {
...
#ifdef CONFIG_SENSORS_TAOS
	rc = pm8xxx_gpio_config(ps_vout.gpio, &ps_vout.config);
	if (rc) {
		pr_err("%s PMIC_GPIO_PS_VOUT failed\n", __func__);
		return rc;
	}
#endif
	...
	/* Deassert GPIO#24 (sink for CHG_STAT on SMB328A) */
	...
	/* Deassert GPIO#38 (sink for TA_CURRENT_SEL on FSA9485UCX) */
	rc = pm8xxx_gpio_config(gpio38.gpio, &gpio38.config);
	if (rc) {
	...
	rc = pm8xxx_gpio_config(cam_flash_set.gpio, &cam_flash_set.config);
	if (rc) {
		pr_err("%s PMIC_GPIO_CAM_FLASH_SET config failed\n", __func__);
		return rc;
	}

	rc = pm8xxx_gpio_config(cam_flash_en.gpio, &cam_flash_en.config);
	if (rc) {
				 ...
				 struct kobj_attribute *attr, char *buf)
{
	return sprintf(buf,
		       ...
		       ":50:842:80:100" ":" __stringify(EV_KEY) ":"
		       __stringify(KEY_MENU) ":170:842:80:100" ":"
		       __stringify(EV_KEY) ":" __stringify(KEY_HOME)
		       ":290:842:80:100" ":" __stringify(EV_KEY) ":"
		       __stringify(KEY_SEARCH) ":410:842:80:100" "\n");
}
...
static const unsigned int prevail2_keymap[] = {
	KEY(0, 0, KEY_CAMERA_SNAPSHOT),
	KEY(0, 1, KEY_CAMERA_FOCUS),
	KEY(0, 2, KEY_VOLUMEUP),
	KEY(0, 3, KEY_VOLUMEDOWN)
};

static struct matrix_keymap_data prevail2_keymap_data = {
	.keymap_size = ARRAY_SIZE(prevail2_keymap),
	.keymap = prevail2_keymap,
};

static struct pm8xxx_keypad_platform_data prevail2_keypad_data = {
	.input_name = "prevail2-keypad",
	.input_phys_device = "prevail2-keypad/input0",

	.num_rows = 5,
	.num_cols = 5,

	.rows_gpio_start = PM8058_GPIO_PM_TO_SYS(9),
	.cols_gpio_start = PM8058_GPIO_PM_TO_SYS(1),

	.debounce_ms = 10,
	.scan_delay_ms = 32,
	.row_hold_ns = 91500,
	.wakeup = 1,
	.keymap_data = &prevail2_keymap_data,
};
...
static struct pmic8058_led pmic8058_prevail2_leds[] = {
	[0] = {
...
static struct pmic8058_leds_platform_data pm8058_prevail2_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_prevail2_leds),
	.leds = pmic8058_prevail2_leds,
};
...
static uint32_t camera_off_vcm_gpio_table[] = {
	GPIO_CFG(1, 0, GPIO_CFG_OUTPUT,
		GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* VCM */
};
...
static uint32_t camera_on_vcm_gpio_table[] = {
	GPIO_CFG(1, 0, GPIO_CFG_OUTPUT,
			GPIO_CFG_PULL_UP, GPIO_CFG_2MA),	/* VCM */
};

static uint32_t camera_on_gpio_table[] = {
	/* parallel CAMERA interfaces */
	GPIO_CFG(3, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	...
	/*GPIO_CFG(15, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_14MA),
	 *//* MCLK *//*requested by curos */
	GPIO_CFG(30, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(17, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(174, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(177, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
};
...
static uint32_t camera_off_gpio_fluid_table[] = {
	...
	/* FLUID: CAMIF_STANDBY */
	GPIO_CFG(CAM_STNDBY, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
		 GPIO_CFG_2MA)
};
...
static uint32_t camera_on_gpio_fluid_table[] = {
	...
	GPIO_CFG(31, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	/* FLUID: CAMIF_STANDBY */
	GPIO_CFG(CAM_STNDBY, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA)
};
...
static void config_camera_off_gpios(void)
{
	...
	if (machine_is_msm7x30_fluid()) {
		...
		gpio_set_value(PM8058_GPIO_PM_TO_SYS
			       (PMIC_GPIO_FLASH_BOOST_ENABLE), 0);
	}
}
...
struct msm_camera_device_platform_data msm_camera_device_data = {
	...
	/*.ioclk.vfe_clk_rate  = 122880000, //refer GB value by teddy */
};
...
static struct i2c_gpio_platform_data VTcamera_i2c_gpio_data = {
	.sda_pin = 174,
	.scl_pin = 177,
};

static struct platform_device VTcamera_i2c_gpio_device = {
	.name = "i2c-gpio",
	.id = 20,
	.dev = {
		.platform_data = &VTcamera_i2c_gpio_data,
		},
};

static struct i2c_board_info msm_VTcamera_boardinfo[] = {
	{
...
/* Duty-cycle % = D / N * 100 */
/* Target : out_freq = 22.4 KHz, 50% duty-cycle */
	.vib_pwm_PreDiv = 0, /* bypass(0), div-by-2(1), by-3(2), by-4(3) */
	.vib_pwm_M = 7, /* M value of M/N:D counter */
	.vib_pwm_N = 6000, /* N value of M/N:D counter */
	.vib_pwm_D = 6000>>1, /* D value of M/N:D counter */
};
...
static struct yda173_i2c_data yda173_data = {
...
static struct i2c_board_info yamahaamp_boardinfo[] = {
	{
	 I2C_BOARD_INFO("yda173", 0xD8 >> 1),
	 .platform_data = &yda173_data,
	 },
};
#endif
...
void msm_snddev_tx_route_config(void)
{
	...
	gpio_tlmm_config(GPIO_CFG
			 (MSM_GPIO_MICBIAS_EN, 0, GPIO_CFG_OUTPUT,
...
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_incall(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_speaker_inVoip1(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip1(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip1(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_speaker_inVoip1(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip1(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip1(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_speaker_inVoip2(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip2(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip2(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_speaker_inVoip2(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip2(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip2(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_speaker_inVoip3(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip3(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip3(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_speaker_inVoip3(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip3(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip3(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_speaker_inVoip4(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip4(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip4(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_speaker_inVoip4(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip4(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip4(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_speaker_inVoip5(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip5(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip5(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_speaker_inVoip5(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_speaker_onoff_inVoip5(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_inVoip5(0);
#endif
...
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff(0);
#endif

}

void msm_snddev_poweramp_on_headset_inVoip1(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip1(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip1(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_headset_inVoip1(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip1(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip1(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_headset_inVoip2(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip2(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip2(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_headset_inVoip2(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip2(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip2(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_headset_inVoip3(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip3(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip3(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_headset_inVoip3(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip3(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip3(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_headset_inVoip4(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip4(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip4(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_headset_inVoip4(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip4(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip4(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_headset_inVoip5(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip5(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip5(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_headset_inVoip5(void)
{

#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff_inVoip5(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_inVoip5(0);
#endif

	pr_info("%s: power off amplifier\n", __func__);
}

void msm_snddev_poweramp_on_headset_incall(void)
{
#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_incall(1);
#endif

}

void msm_snddev_poweramp_off_headset_incall(void)
{
#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_incall(0);
#endif

}


void msm_snddev_poweramp_on_headset_fac(void)
{
#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff(1);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_fac(1);
#endif

}

void msm_snddev_poweramp_off_headset_fac(void)
{
#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_onoff(0);
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_headset_onoff_fac(0);
#endif
...
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_headset_onoff(1);
#endif
...
#endif
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_headset_onoff(0);
#endif
...
static unsigned aux_pcm_gpio_on[] = {
	GPIO_CFG(138, 1, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* PCM_DOUT */
	GPIO_CFG(139, 1, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* PCM_DIN  */
	GPIO_CFG(140, 1, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* PCM_SYNC */
	GPIO_CFG(141, 1, GPIO_CFG_OUTPUT,
...
int mi2s_unconfig_data_gpio(u32 direction, u8 sd_line_mask)
{
	...
	case DIR_RX:
		...
		while (sd_line_mask) {
			if (sd_line_mask & 0x1)
				msm_gpios_disable_free(mi2s_rx_data_lines_gpios
						       + i, 1);
...
#if CONFIG_SENSORS_TAOS
static struct i2c_gpio_platform_data opt_i2c_gpio_data = {
	.sda_pin = OPT_GPIO_ALS_SDA,
	.scl_pin = OPT_GPIO_ALS_SCL,
	.udelay = 2,
};
...
static struct vreg *opt_vreg_L13;
static struct vreg *opt_vreg_L11;

int taos_power_led_en(int on)
{
	pr_info("%s: %d\n", __func__, on);
...
int taos_power_en(int on)
{
	pr_info("%s: %d\n", __func__, on);

	if (opt_vreg_L13 == NULL) {
		pr_err("%s: vreg L13 null!\n", __func__);
		return -EPERM;
	}

	if (on)
		vreg_enable(opt_vreg_L13);
	else
		vreg_disable(opt_vreg_L13);

	/* ensure power is stablized */
	msleep(20);
	return 0;
}
static struct taos_platform_data taos_plat_data = {
	.power_en = taos_power_en,
	.power_led = taos_power_led_en,
	.wakeup = 1,
};
...
static int __init optical_device_init(void)
{
	...
	opt_vreg_L13 = vreg_get(NULL, "wlan");

	if (IS_ERR(opt_vreg_L13)) {
		rc = PTR_ERR(opt_vreg_L13);
		pr_err("%s: opt_vreg_L13 get failed (%d)\n", __func__, rc);
		return rc;
	}
	rc = vreg_set_level(opt_vreg_L13, 2600);
	if (rc) {
		pr_err("%s: opt_vreg_L13 set level failed (%d)\n",
		       __func__, rc);
		return rc;
	}
	rc = vreg_enable(opt_vreg_L13);
	if (rc) {
		pr_err("%s: opt_vreg_L13 enable failed (%d)\n", __func__, rc);
		return rc;
	}
...
#if defined(CONFIG_SENSORS_YAS_ACCEL_DRIVER) || defined(CONFIG_SENSORS_YAS530C)
static struct i2c_gpio_platform_data acc_mag_i2c_gpio_data = {
	.sda_pin = ACCEL_SENSORS_GPIO_SDA,
	.scl_pin = ACCEL_SENSORS_GPIO_SCL,
};
#if defined(CONFIG_SENSORS_YAS530C)
static struct platform_device yas532_orient_device = {
	.name			= "orientation",
};
#endif
static struct platform_device acc_mag_i2c_gpio_device = {
	.name = "i2c-gpio",
	.id = 8,
	.dev = {
		.platform_data = &acc_mag_i2c_gpio_data,
		},
};
...
{
	gpio_set_value_cansleep(PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_MSENSE_RST),
				!!on);
	return 0;
}
...
static int __init magnetic_device_init(void)
{
	...
	mag_vreg_main = vreg_get(NULL, "wlan");
...
static struct i2c_board_info acc_mag_i2c_gpio_devices[] = {
...
static int __init fg17043_gpio_init(void)
{
	...
	for (pin = 0; pin < ARRAY_SIZE(fg17043_gpio_on); pin++) {
		rc = gpio_tlmm_config(fg17043_gpio_on[pin], GPIO_CFG_ENABLE);
		if (rc) {
			printk(KERN_ERR
			       "%s: gpio_tlmm_config(%#x)=%d\n",
...
static int __init buses_init(void)
{
	...
	pm8058_7x30_data.keypad_pdata = &prevail2_keypad_data;
	...
	if (machine_is_msm8x55_svlte_surf() || machine_is_msm8x55_svlte_ffa()) {
		if (gpio_cfg_marimba)
			gpio_set_value(GPIO_PIN
				       (marimba_svlte_config_clock->gpio_cfg),
				       1);
		else
			gpio_set_value(GPIO_PIN
				       (marimba_svlte_config_clock->gpio_cfg),
...
static void fm_radio_shutdown(struct marimba_fm_platform_data *pdata)
{
	...
	rc = pmapp_clock_vote(id, PMAPP_CLOCK_ID_DO, PMAPP_CLOCK_VOTE_OFF);
	if (rc < 0)
...
#ifdef CONFIG_USB_SWITCH_FSA9485
#define MSM_FSA9485_I2C_BUS_ID 10
#define micro_usb_i2c_gpio_sda 35
#define micro_usb_i2c_gpio_scl 36

static unsigned fsa9485_gpio_on[] = {
	GPIO_CFG(micro_usb_i2c_gpio_sda, 0,
		 GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(micro_usb_i2c_gpio_scl, 0,
		 GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
};

static int __init fsa9485_gpio_init(void)
{
	int pin, rc;

	pr_info("fsa9485_gpio_init\n");
	for (pin = 0; pin < ARRAY_SIZE(fsa9485_gpio_on); pin++) {
		rc = gpio_tlmm_config(fsa9485_gpio_on[pin], GPIO_CFG_ENABLE);
		if (rc) {
			printk(KERN_ERR
			       "%s: gpio_tlmm_config(%#x)=%d\n",
			       __func__, fsa9485_gpio_on[pin], rc);
		}
	}
	return rc;
}
...
static void fsa9485_dock_cb(int attached)
{
	...
	/* Charging related */
	if (attached == FSA9485_ATTACHED_DESK_DOCK)
		set_cable_status = CABLE_TYPE_DESK_DOCK;
	else if (attached == FSA9485_ATTACHED_CAR_DOCK)
...
static unsigned int fsa9485_system_rev(void)
{
	return system_rev;
}
...
static struct fsa9485_platform_data fsa_plat_data = {
...
#endif				/* CONFIG_USB_SWITCH_FSA9485 */
...
static struct msm_gpio smsc911x_gpios[] = {
	{GPIO_CFG(172, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "ebi2_addr6"},
	{GPIO_CFG(173, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "ebi2_addr5"},
	{GPIO_CFG(174, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "ebi2_addr4"},
	{GPIO_CFG(175, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "ebi2_addr3"},
	{GPIO_CFG(176, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "ebi2_addr2"},
	{GPIO_CFG(177, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "ebi2_addr1"},
	{GPIO_CFG(178, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "ebi2_addr0"},
	{GPIO_CFG(88, 2, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	 "smsc911x_irq"},
};
...
static struct msm_gpio optnav_config_data[] = {
	{GPIO_CFG
	 (OPTNAV_CHIP_SELECT, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
	  GPIO_CFG_8MA),
	 "optnav_chip_select"},
};
...
#define GPIO_TOUCH_SDA	87
#define GPIO_TOUCH_SCL	88
#define GPIO_TOUCH_IRQ	89

struct tsp_callbacks *charger_callbacks_tsp;
...
void melfas_vdd_on(bool onoff)
{
	...
	if (ret) {
			printk(KERN_ERR "%s: VTOUCH_2.8V"
				"set level failed (%d)\n", __func__, ret);
	} else {
		printk(KERN_ERR "%s: VTOUCH_2.8V set"
	       "level success\n", __func__);
	}

	regulator_touchio = regulator_get(NULL, "gp13");
	ret = regulator_set_voltage(regulator_touchio, 1800000, 1800000);
	if (ret) {
		printk(KERN_ERR "%s: VTOUCHIO_1.8V"
			"set level failed (%d)\n", __func__, ret);
	} else {
		printk(KERN_ERR "%s: VTOUCH_1.8V set"
		       "level success\n", __func__);
	}
	if (onoff) {
		...
		if (ret) {
			printk(KERN_ERR "%s: vreg_touch enable"
				"failed (%d)\n", __func__, ret);
			/*return -EIO;*/
		} else {
			printk(KERN_ERR "%s: wlan2_vreg_touch"
				"enable success!\n", __func__);
		}

		ret = regulator_enable(regulator_touchio);
		if (ret) {
			printk(KERN_ERR "%s: vreg_touchio enable"
				"failed (%d)\n", __func__, ret);
			/*return -EIO;*/
		} else {
			printk(KERN_ERR "%s: gp13_vreg_touchio"
				"enable success!\n", __func__);
		}
	} else {
		...
		ret = regulator_disable(regulator_touchio);
		if (ret) {
			printk(KERN_ERR "%s: vreg_touchio disable"
				"failed (%d)\n", __func__, ret);
			/*return -EIO;*/
		} else {
			printk(KERN_ERR "%s: gp13_vreg_touchio"
...
int is_melfas_vdd_on(void)
{
	...
	if (!regulator_touch) {
		regulator_touch = regulator_get(NULL, "wlan2");
		if (IS_ERR(regulator_touch)) {
			ret = PTR_ERR(regulator_touch);
			printk(KERN_ERR "%d:Could not get 2.8V\n", ret);
			return ret;
		}

		ret = regulator_set_voltage(regulator_touch, 2800000, 2800000);
		if (ret) {
			printk(KERN_ERR "%s: Could not set vreg_touch"
				"\n", __func__);
			return ret;
		}
	}

	if (regulator_is_enabled(regulator_touch))
		return 1;
	else
		return 0;
...
static struct mms_ts_platform_data melfas_data = {
	.max_x = 320,
	.max_y = 480,
	.use_touchkey = USE_TOUCHKEY,
	.touchkey_keycode = touchkey_keycode,
	.num_of_keycode = ARRAY_SIZE(touchkey_keycode),
	.config_fw_version = "M830_ME_0627",
...
static struct i2c_board_info mms_ts_boardinfo[] = {
	{
...
static struct platform_device touchscreen_i2c_gpio_device_mms = {
	.name = "i2c-gpio",
	.id = 5,
	.dev = {
...
static struct msm_gpio qsd_spi_gpio_config_data[] = {
	{GPIO_CFG(45, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "spi_clk"},
	{GPIO_CFG(46, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "spi_cs0"},
	{GPIO_CFG(47, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	 "spi_mosi"},
	{GPIO_CFG(48, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "spi_miso"},
};
...
static struct msm_gpio lcdc_gpio_config_data[] = {
	{GPIO_CFG(45, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "spi_clk"},
	{GPIO_CFG(46, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "spi_cs0"},
	{GPIO_CFG(47, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "spi_mosi"},
	{GPIO_CFG(145, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcd_reset"},
};
...
static struct msm_gpio lcdc_gpio_sleep_config_data[] = {
	...
	{GPIO_CFG(145, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcd_reset"},
	{GPIO_CFG(48, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "spi_miso"},
};
...
static struct msm_gpio dtv_panel_gpios[] = {
	{GPIO_CFG(120, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
	 "wca_mclk"},
	{GPIO_CFG(121, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
	 "wca_sd0"},
	{GPIO_CFG(122, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
	 "wca_sd1"},
	{GPIO_CFG(123, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
	 "wca_sd2"},
	{GPIO_CFG(124, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	 "dtv_pclk"},
...
static int __init hdmi_init_regs(void)
{
	...
	rc = regulator_bulk_get(NULL, ARRAY_SIZE(hdmi_cec_regs), hdmi_cec_regs);
...
static int hdmi_enable_5v(int on)
{
	...
	if (on) {
		...
		gpio_set_value_cansleep(PM8058_GPIO_PM_TO_SYS
					(pmic_gpio_hdmi_5v_en), 1);
	} else {
		gpio_set_value_cansleep(PM8058_GPIO_PM_TO_SYS
					(pmic_gpio_hdmi_5v_en), 0);
...
static int hdmi_comm_power(int on, int show)
{
	...
	return on ?
	    regulator_bulk_enable(ARRAY_SIZE(hdmi_comm_regs),
				  hdmi_comm_regs) :
	    regulator_bulk_disable(ARRAY_SIZE(hdmi_comm_regs), hdmi_comm_regs);
}
...
static int hdmi_core_power(int on, int show)
{
	...
	return on ?
	    regulator_bulk_enable(ARRAY_SIZE(hdmi_core_regs),
				  hdmi_core_regs) :
	    regulator_bulk_disable(ARRAY_SIZE(hdmi_core_regs), hdmi_core_regs);
}
...
static int hdmi_cec_power(int on)
{
	...
	return on ? regulator_bulk_enable(ARRAY_SIZE(hdmi_cec_regs),
					  hdmi_cec_regs) :
	    regulator_bulk_disable(ARRAY_SIZE(hdmi_cec_regs), hdmi_cec_regs);
}
...
* of hsync, vsync and data enable.
*/
static char mdp_polarity(char *command, char polarity)
{
	static char ret;
	char *cmd = command;
	/*
	 * The order of the polarity
	 * 2^0 is for data enable polarity
	 * 2^1 is for vsync polarity
	 * 2^2 is for hsync polarity
	 */
	if (!strncmp(cmd, "GET", 3))
		return (ret & (1 << polarity)) >> polarity;
...
/*
* The function of "update_panel_info()" is working for support
...
*/
static int __init update_panel_info(char *panel_name)
{
	int i;
	char *src = panel_name;
	char panel[2][4] = { "AUO", "NONE" };
	char polarity[2] = { 0, 0 };
	int panel_id[2] = { 1, 2 };
	static int lcd_id = -1;
...
__setup("panel_name=", update_panel_info);

static int msm_fb_detect_panel(const char *name)
{
	int ret = -EPERM;
	char panel[2][21] = { "lcdc_s6d05a1_hvga", "NONE" };
	int lcd_id = -1;
	lcd_id = update_panel_info("GET");
	printk(KERN_INFO "LCD %s selected\n", panel[lcd_id - 1]);

	if (!strncmp(name, panel[lcd_id - 1], sizeof(panel[lcd_id - 1])))
		ret = 0;
	else
		ret = -ENODEV;
...
/*
	...
	if (!strncmp(name, "lcdc_s6d16a0_wvga", 20))
		return 0;
#elif defined(CONFIG_FB_MSM_LCDC_LD9040_WVGA_PANEL)
	if (!strncmp(name, "lcdc_ld9040_wvga", 20))
		return 0;
#elif defined(CONFIG_FB_MSM_LCDC_S6D05A1_HVGA_PANEL)
	if (!strncmp(name, "lcdc_s6d05a1_hvga", 20))
		return 0;
#endif
	else
*/
...
static struct msm_gpio lcd_panel_gpios[] = {
	...
	{GPIO_CFG(25, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
	 "lcdc_red2"},
	{GPIO_CFG(90, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
	 "lcdc_pclk"},
...
static struct msm_gpio lcd_panel_gpios_sleep_cfg[] = {
	...
	{GPIO_CFG(22, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_blu2"},
	{GPIO_CFG(23, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red0"},
	{GPIO_CFG(24, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red1"},
	{GPIO_CFG(25, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red2"},
	...
	{GPIO_CFG(93, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_hsync"},
	{GPIO_CFG(94, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_grn2"},
	...
	{GPIO_CFG(101, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_blu4"},
	{GPIO_CFG(102, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_blu5"},
	{GPIO_CFG(103, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_blu6"},
	{GPIO_CFG(104, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_blu7"},
	{GPIO_CFG(105, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red3"},
	{GPIO_CFG(106, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red4"},
	{GPIO_CFG(107, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red5"},
	{GPIO_CFG(108, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red6"},
	{GPIO_CFG(109, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red7"},
};

static int lcdc_s6d05a1_panel_power(int on)
{
	int rc, i;
	struct msm_gpio *gp;
	...
	if (on) {
		...
		gp = lcd_panel_gpios_sleep_cfg;
		for (i = 0; i < ARRAY_SIZE(lcd_panel_gpios_sleep_cfg); i++) {
			/* ouput low */
...
static int lcdc_panel_power(int on)
{
	...
	return lcdc_s6d05a1_panel_power(on);
...
#ifdef CONFIG_TOUCHSCREEN_MMS128
	&touchscreen_i2c_gpio_device_mms,
#endif
...
static struct msm_gpio msm_i2c_gpios_hw[] = {
	{GPIO_CFG(70, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "i2c_scl"},
	{GPIO_CFG(71, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "i2c_sda"},
};

static struct msm_gpio msm_i2c_gpios_io[] = {
	{GPIO_CFG(70, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
		  GPIO_CFG_16MA), "i2c_scl"},
	{GPIO_CFG(71, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
		  GPIO_CFG_16MA), "i2c_sda"},
};
...
static struct msm_gpio msm_nand_ebi2_cfg_data[] = {
	{GPIO_CFG(86, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "ebi2_cs1"},
	{GPIO_CFG(115, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "ebi2_busy1"},
};
#endif
...
static struct msm_gpio sdc1_lvlshft_cfg_data[] = {
	{GPIO_CFG(35, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA),
	 "sdc1_lvlshft"},
};
#endif
static struct msm_gpio sdc1_cfg_data[] = {
	{GPIO_CFG(38, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
		  GPIO_CFG_16MA), "sdc1_clk"},
	{GPIO_CFG(39, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc1_cmd"},
	{GPIO_CFG(40, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc1_dat_3"},
	{GPIO_CFG(41, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc1_dat_2"},
	{GPIO_CFG(42, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc1_dat_1"},
	{GPIO_CFG(43, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc1_dat_0"},
};

/*
static struct msm_gpio sdc2_cfg_data[] = {
	{GPIO_CFG(64, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
			GPIO_CFG_16MA), "sdc2_clk"},
	{GPIO_CFG(65, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_cmd"},
	{GPIO_CFG(66, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_dat_3"},
	{GPIO_CFG(67, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_dat_2"},
	{GPIO_CFG(68, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_dat_1"},
	{GPIO_CFG(69, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_dat_0"},

#ifdef CONFIG_MMC_MSM_SDC2_8_BIT_SUPPORT
	{GPIO_CFG(115, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_dat_4"},
	{GPIO_CFG(114, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_dat_5"},
	{GPIO_CFG(113, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_dat_6"},
	{GPIO_CFG(112, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
			GPIO_CFG_8MA), "sdc2_dat_7"},
#endif
};
*/
static struct msm_gpio sdc3_cfg_data[] = {
	{GPIO_CFG(110, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
		  GPIO_CFG_16MA), "sdc3_clk"},
	{GPIO_CFG(111, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc3_cmd"},
	{GPIO_CFG(116, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc3_dat_3"},
	{GPIO_CFG(117, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc3_dat_2"},
	{GPIO_CFG(118, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc3_dat_1"},
	{GPIO_CFG(119, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA), "sdc3_dat_0"},
};
...
static struct msm_gpio sdc4_cfg_data[] = {
	{GPIO_CFG(58, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "sdc4_clk"},
	{GPIO_CFG(59, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc4_cmd"},
	{GPIO_CFG(60, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc4_dat_3"},
	{GPIO_CFG(61, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc4_dat_2"},
	{GPIO_CFG(62, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc4_dat_1"},
...
static uint32_t msm_sdcc_setup_gpio(int dev_id, unsigned int enable)
{
	...
	if (enable) {
		...
		if (rc)
			printk(KERN_ERR
			       "%s: Failed to turn on GPIOs for slot %d\n",
			       __func__, dev_id);
	} else {
...
static uint32_t mbp_setup_power(struct device *dv, unsigned int power_status)
{
	int rc = 0;
	struct platform_device *pdev;
...
int mbp_register_status_notify(void (*callback) (int, void *), void *dev_id)
{
...
#ifdef CONFIG_MMC_MSM_SDC4_SUPPORT
	if (system_rev >= 2) {
		gpio_direction_output(GPIO_TFLASH_EN, 0);
		set_bit(4, &vreg_sts);
		gpio_set_value(GPIO_TFLASH_EN, 1);
	}
...
#define TSIF_B_SYNC	\
	GPIO_CFG(37, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_B_DATA	\
	GPIO_CFG(36, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_B_EN	\
	GPIO_CFG(35, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
...
{
	pm8058_7x30_data.leds_pdata = &pm8058_prevail2_leds_data;
}
...
static struct msm_gpio tsc2007_config_data[] = {
	{GPIO_CFG
	 (TSC2007_TS_PEN_INT, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL,
	  GPIO_CFG_2MA),
	 "tsc2007_irq"},
};
...
#endif
#ifdef CONFIG_TOUCHSCREEN_MMS128
	i2c_register_board_info(5, mms_ts_boardinfo,
				ARRAY_SIZE(mms_ts_boardinfo));
	mms_tsp_input_init();
#endif
...
*/
	if (machine_is_msm7x30_fluid())
		i2c_register_board_info(0, cy8info, ARRAY_SIZE(cy8info));
#ifdef CONFIG_BOSCH_BMA150
	if (machine_is_msm7x30_fluid())
	...
	pr_info("yda173:register yamaha amp device\n");
#endif
#if 0
...
#if defined(CONFIG_SENSORS_YAS_ACCEL_DRIVER) || defined(CONFIG_SENSORS_YAS530C)
	i2c_register_board_info(8, acc_mag_i2c_gpio_devices,
				ARRAY_SIZE(acc_mag_i2c_gpio_devices));
#endif
#if defined(CONFIG_SENSORS_TAOS)
...
#endif
#ifdef CONFIG_SR130PC10
	/* 1.3M front camera new add */
	i2c_register_board_info(20, msm_VTcamera_boardinfo,
		ARRAY_SIZE(msm_VTcamera_boardinfo));
#endif
...
#ifdef CONFIG_SEC_DEBUG
	sec_getlog_supply_meminfo(0x10000000, 0x00000000, 0x00, 0x00);
#endif
}
...
MACHINE_START(PREVAIL2, "SPH-M830")
