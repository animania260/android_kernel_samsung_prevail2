...
static struct cypress_touchkey_platform_data cypress_touchkey_pdata = {
	.gpio_int = 26,
	.gpio_led_en = 79,
	.touchkey_keycode = NULL,
	.power_onoff = cypress_power_onoff,
};

static struct i2c_board_info touchkey_i2c_devices_info[] = {
	{
...
static void cypress_rev_check(void)
{
	if (system_rev <= 2)
		cypress_touchkey_i2c_gpio_data.sda_pin = 83;
	else
		cypress_touchkey_i2c_gpio_data.sda_pin = 80;
}
...
{
	return sprintf(buf, __stringify(EV_KEY) ":" __stringify(KEY_BACK)
...
static const unsigned int icon_keymap[] = {
...
static struct matrix_keymap_data icon_keymap_data = {
	.keymap_size = ARRAY_SIZE(icon_keymap),
	.keymap = icon_keymap,
};

static struct pm8xxx_keypad_platform_data icon_keypad_data = {
	.input_name = "icon-keypad",
	.input_phys_device = "icon-keypad/input0",
...
static struct pmic8058_led pmic8058_icon_leds[] = {
	[0] = {
	       .name = "blue",
	       .max_brightness = 1,
...
static struct pmic8058_leds_platform_data pm8058_icon_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_icon_leds),
	.leds = pmic8058_icon_leds,
};
...
static int __init buses_init(void)
{
	...
	pm8058_7x30_data.keypad_pdata = &icon_keypad_data;
...
static struct i2c_board_info fuelgauge_i2c_devices[] = {
	{
	 I2C_BOARD_INFO("fuelgauge_max17043", 0x6C >> 1),
...
static struct msm_gpio optnav_config_data[] = {
	{GPIO_CFG(OPTNAV_CHIP_SELECT, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
		  GPIO_CFG_8MA),
	 "optnav_chip_select"},
};
...
struct ftk_i2c_platform_data ftk_data = {
	.power = ftk_vdd_on,
};

static struct i2c_board_info ftk_touch_boardinfo[] = {
	{
	 I2C_BOARD_INFO("ftk", 0x4B),
	 .irq = MSM_GPIO_TO_INT(89),
	 .platform_data = &ftk_data,
	 }
};
...
static struct msm_gpio lcdc_gpio_config_data[] = {
	...
	{GPIO_CFG(145, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	 "lcd_reset"},
	{GPIO_CFG(48, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "spi_miso"},
};
...
{
	int ret = -EPERM;
	char panel[2][21] = { "lcdc_r69329_wvga", "lcdc_nt35510_wvga" };
	int lcd_id = -1;
...
static struct msm_gpio lcd_panel_gpios_sleep_cfg[] = {
	...
	{GPIO_CFG(109, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "lcdc_red7"},
	{GPIO_CFG(144, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	 "nc"},
};
...
static struct msm_gpio msm_i2c_gpios_io[] = {
	{GPIO_CFG(70, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "i2c_scl"},
	{GPIO_CFG(71, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "i2c_sda"},
};

static struct msm_gpio qup_i2c_gpios_io[] = {
	{GPIO_CFG(16, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "qup_scl"},
	{GPIO_CFG(17, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "qup_sda"},
};

static struct msm_gpio qup_i2c_gpios_hw[] = {
	{GPIO_CFG(16, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "qup_scl"},
	{GPIO_CFG(17, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "qup_sda"},
};
...
static struct msm_gpio sdc1_cfg_data[] = {
	{GPIO_CFG(38, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "sdc1_clk"},
	{GPIO_CFG(39, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc1_cmd"},
	{GPIO_CFG(40, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc1_dat_3"},
	{GPIO_CFG(41, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc1_dat_2"},
	{GPIO_CFG(42, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc1_dat_1"},
	{GPIO_CFG(43, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc1_dat_0"},
};
...
static struct msm_gpio sdc2_cfg_data[] = {
	...
	{GPIO_CFG(67, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc2_dat_2"},
	{GPIO_CFG(68, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc2_dat_1"},
	{GPIO_CFG(69, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc2_dat_0"},

#ifdef CONFIG_MMC_MSM_SDC2_8_BIT_SUPPORT
	{GPIO_CFG(115, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc2_dat_4"},
	{GPIO_CFG(114, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc2_dat_5"},
	{GPIO_CFG(113, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc2_dat_6"},
...
static struct msm_gpio sdc3_cfg_data[] = {
	{GPIO_CFG(110, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	 "sdc3_clk"},
	{GPIO_CFG(111, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc3_cmd"},
	{GPIO_CFG(116, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc3_dat_3"},
	{GPIO_CFG(117, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc3_dat_2"},
	{GPIO_CFG(118, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc3_dat_1"},
	{GPIO_CFG(119, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	 "sdc3_dat_0"},
};
...
static uint32_t msm_sdcc_setup_power(struct device *dv, unsigned int vdd)
{
	...
	if (pdev->id == 4)	/* S3 is always ON and cannot be disabled */
		pr_info("%s: SD Card Power Setup (%d)\n", __func__, vdd);
...
{
	pm8058_7x30_data.leds_pdata = &pm8058_icon_leds_data;
}
...
static struct msm_gpio tsc2007_config_data[] = {
	{GPIO_CFG(TSC2007_TS_PEN_INT, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL,
		  GPIO_CFG_2MA),
	 "tsc2007_irq"},
};
...
static void __init msm7x30_init(void)
{
...
#ifdef CONFIG_KEYBOARD_CYPRESS_TOUCH
	i2c_register_board_info(17, touchkey_i2c_devices_info,
				ARRAY_SIZE(touchkey_i2c_devices_info));
	cypress_touchkey_pdata.touchkey_keycode = touchkey_keycode;
#endif
	...
	if (system_rev >= 1) {
		...
		i2c_register_board_info(5, ftk_touch_boardinfo,
					ARRAY_SIZE(ftk_touch_boardinfo));
	}
