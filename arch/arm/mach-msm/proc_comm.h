...
enum {
	...
	/* PCOM_OEM_SAMSUNG_RDM_ASSIGN_CMD: data1 is service, data2 is device */
	/* for meaning of values see modem source code(smem_ext_pc.c) */
	PCOM_OEM_SAMSUNG_RDM_GET_SERVICE_CMD,
	PCOM_OEM_SAMSUNG_RDM_ASSIGN_CMD,
	PCOM_OEM_SAMSUNG_SLEEP_DEBUG_CMD,

	PCOM_OEM_LAST = PCOM_OEM_SAMSUNG_SLEEP_DEBUG_CMD,
=======
	PCOM_NUM_CMDS,
>>>>>>> msm-linux-3.0.y/korg/linux-3.0.y
};
